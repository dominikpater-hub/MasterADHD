...
const ATLAS=[
  ...
  {id:'rozczarowanie',nm:'Rozczarowanie',em:'😞',fam:'smutek',val:-1,obj:'strata',pew:.8,spr:'okoliczności',tend:'rewizja oczekiwań',myli:['smutek','zal'],pyt:'Czy coś nie spełniło Twoich oczekiwań?',opis:'Rzeczywistość rozminęła się z oczekiwaniem. Nie utrata na zawsze.'},
  {id:'zal',nm:'Żal',em:'😔',fam:'smutek',val:-1,obj:'strata',pew:.9,spr:'ja, moje wnętrze',tend:'rozpamiętywanie „gdybym…”',myli:['wina','rozczarowanie'],pyt:'Czy wracasz do własnej decyzji — „mogło potoczyć się inaczej”?',opis:'Kontrfaktyczne rozpamiętywanie własnej decyzji.'},
  ...
  {id:'wstyd',nm:'Wstyd',em:'🫥',fam:'samo',val:-1,obj:'ja',pew:.9,spr:'ja, moje wnętrze',tend:'ukrycie, zniknięcie',myli:['wina','upokorzenie'],pyt:'Czy to ocena całego siebie („coś ze mną jest nie tak”), a nie jednego czynu?',opis:'Negatywna ocena całego „ja”. Ciało się kurczy, chce zniknąć.'},
  {id:'wina',nm:'Wina',em:'😣',fam:'samo',val:-1,obj:'ja',pew:.9,spr:'ja, moje wnętrze',tend:'naprawa, przeprosiny',myli:['wstyd','zal'],pyt:'Czy chodzi o konkretne zachowanie, które chcesz naprawić?',opis:'Negatywna ocena konkretnego czynu. Ciągnie do naprawienia.'},
  {id:'zazenowanie',nm:'Zażenowanie',em:'😳',fam:'samo',val:-1,obj:'ja',pew:.6,spr:'ja, moje wnętrze',tend:'gesty pojednawcze, rumieniec',myli:['wstyd'],pyt:'Czy to przelotne potknięcie wobec ludzi, nie sprawa moralna?',opis:'Przypadkowe naruszenie konwencji przy świadkach. Lekkie, przelotne.'},
  ...
  {id:'duma',nm:'Duma',em:'😌',fam:'poz',val:1,obj:'ja',pew:1,spr:'ja, moje wnętrze',tend:'wyprostowanie',myli:['radosc'],pyt:'Czy przypisujesz to własnemu wysiłkowi i osiągnięciu?',opis:'Pozytywna ocena siebie za osiągnięcie z wysiłku.'},
  {id:'ulga',nm:'Ulga',em:'😮‍💨',fam:'poz',val:1,obj:'dobro',pew:.9,spr:'okoliczności',tend:'rozluźnienie, wydech',myli:['radosc','zadowolenie'],pyt:'Czy właśnie minęło coś, co Cię niepokoiło?',opis:'Zagrożenie minęło. Napięcie schodzi.'},
  ...
  {id:'zaskoczenie',nm:'Zaskoczenie',em:'😯',fam:'inne',val:0,obj:'zmiana',pew:.5,spr:'nic konkretnego',tend:'orientacja, zatrzymanie',myli:['strach','radosc'],pyt:'Czy coś naruszyło Twoje oczekiwania — zanim padła ocena, dobre czy złe?',opis:'Neutralna, bardzo krótka. Zwykle przechodzi w inną emocję.'},
...
function survVal(v){ SURV.val=v; buzz(BUZZ.easier); nowSwap(`
    ...
    <div class="surv-opts">
      ${[['zagrozenie','⚠️','Zagrożenie','coś może się źle skończyć'],['przeszkoda','🧱','Przeszkoda','coś stoi mi na drodze'],['strata','🍂','Strata','coś się skończyło / nie wyszło'],['ja','🪞','Ja','chodzi o mnie, o to kim jestem'],['inni','👥','Inni ludzie','ktoś inny, porównanie, relacja'],['dobro','✨','Coś dobrego','wydarzyło się coś fajnego'],['zmiana','⚡','Nagła zmiana','coś mnie zaskoczyło']].map(([id,em,n,d])=>`<button class="surv-o" onclick="survObj('${id}')">${em} <b>${n}</b><small>${d}</small></button>`).join('')}
    </div>
  `,`<button class="btn btn-ghost" onclick="exitNow()">Nie teraz</button>`); }
